...
public class DepartmentHome {
	...
	public Department merge(Department detachedInstance) {
		...
		try {
			Department result = (Department) getSessionFactory().getCurrentSession().merge(detachedInstance);
	...
	public Department findById(java.lang.Integer id) {
		...
		try {
			Department instance = (Department) getSessionFactory().getCurrentSession().get("Department", id);
			if (instance == null) {
	...
	public List findByExample(Department instance) {
		...
		try {
			List results = getSessionFactory().getCurrentSession().createCriteria("Department")

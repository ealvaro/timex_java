		...
		<table width="100%" border="0" align="center" cellpadding="4"
			...
			<tr>
				...
				<p>Employee Id: <spring:bind path="command.employeeId">
					...
					<input name='<c:out value="${status.expression}"/>' type="password"
						value='<c:out value="${status.value}"/>' size="8" maxlength="10">
				</spring:bind> &nbsp;<input type="submit" name="Submit" value="Sign In"></p>
				</div>
				</form>
				</td>
			</tr>
